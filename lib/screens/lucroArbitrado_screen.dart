...
class LucroArbitradoScreen extends StatefulWidget {
  final Map<String, TextEditingController> controllers;

  LucroArbitradoScreen({required this.controllers});

  @override
  _LucroArbitradoScreenState createState() => _LucroArbitradoScreenState();
}

class _LucroArbitradoScreenState extends State<LucroArbitradoScreen> {
  List<Map<String, dynamic>> lucroArbitrado = [];
  int currentPage = 1;
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.get(Uri.parse(
        'http://127.0.0.1:5000/lucroArbitrado?page=$currentPage&limit=$rowsPerPage&$queryParams'));
